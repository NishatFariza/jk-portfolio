...
const MobileHeroPanel = () => {
  return (
    <div className="flex justify-start absolute top-[20%] left-0 md:hidden">
      <div className="flex flex-col justify-center items-center gap-3 w-4/12">
        ...
        <Link href="https://www.linkedin.com/in/jjkrasnick/" target={"_b"}>
          <svg
            className="w-4 h-4"
            role="img"
            viewBox="0 0 24 24"
        ...
        <Link href="https://twitter.com/jjkrasnick" target={"_b"}>
          <svg
            className="w-4 h-4"
            role="img"
            viewBox="0 0 24 24"
...
export default MobileHeroPanel